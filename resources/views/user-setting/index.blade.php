                    ...
                    <div>
                        <table class="w-full text-[#152A75]">
                            ...
                            <tr class="text-center">
                                ...
                                <td class="border border-[#277ACD]">bambang2</td>
                                <td class="border border-[#277ACD]">Admin</td>
            ...
            <form action="" class="space-y-10">
                <div class="space-y-4">
                    <div class="grid grid-cols-12 items-center">
                        ...
                        <input type="text" name="" id="" class="col-span-10 border py-2 px-4 border-[#277ACD] rounded-lg w-full">
                    </div>
                    <div class="grid grid-cols-12 items-center">
                ...
                <div class="flex justify-end gap-3">
                    <button class="text-white bg-[#0B8908] py-2 rounded-lg px-10">Ubah</button>
                    <button onclick="toggleEditModal(1)" class="bg-[#D7D7D7] py-2 rounded-lg px-10">Tutup</button>
                </div>
            </form>
        </div>
    </div>
