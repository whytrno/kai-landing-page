...
<nav>
    <div class="flex justify-between py-2 items-center px-10 bg-[#152A75] text-white font-bold w-full">
        ...
        <div class="gap-5 flex">
            ...
            <div>
                <button onclick="togglePengaturanModal()" class="{{Request::path() == 'pengaturan' ? 'text-[#C95C0D]' : 'hover:text-[#C95C0D]'}} flex gap-2 items-center">
                    View Video
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="chevron w-4 h-4">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                    </svg>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="chevron hidden w-4 h-4">
