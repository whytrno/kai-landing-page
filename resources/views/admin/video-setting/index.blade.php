...
@section('content')
            ...
            <div class="space-y-5 bg-white rounded-t-lg">
                ...
                <div class="px-10 pb-10 space-y-5">
                    <div class="flex justify-between">
                        <button onclick="toggleAddModal()" class="font-semibold px-8 py-2 rounded-lg bg-[#277ACD] text-white">Tambah Video</button>
                        <form action="">
                            <label for="">Search:</label>
                            <input type="text" class="px-2 rounded-lg border-2 border-[#277ACD]">
                        </form>
                    </div>
                                ...
                                <td class="border border-[#277ACD]">
                                    <div class=" flex gap-3 justify-center items-center">
                                        <button onclick="toggleEditModal(1)">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 stroke-[#277ACD]">
            ...
            <form action="" class="space-y-10">
                <div class="space-y-2 col-span-2">
                    ...
                    <div onclick="document.getElementById('file').click()" id="file-container"
                        ...
                        <p id="file-name" class="font-semibold text-center">Lampirkan file Anda di sini <br> atau <br> Jelajahi file</p>
                    </div>
                    <div class="text-black/30">
                        <p>Jenis file yang diterima: .xls/.xlsx/.xlsm/.csv</p>
                    </div>
                    <input type="file" name="video" id="file" class="hidden">
                </div>
    ...
    <div id="editModal1" class="hidden fixed top-0 left-0 flex items-center justify-center w-full h-full">
        <div class="absolute z-99 bg-white p-6 rounded-lg space-y-5 w-2/5">
            <div class="flex justify-between items-center border-b border-black pb-4">
                <h1 class="text-2xl font-bold">Tambah Video</h1>
                <button onclick="toggleEditModal(1)">
            ...
            <form action="" class="space-y-10">
                ...
                <button class="bg-blue-600 w-full rounded-lg py-2 text-white">Simpan</button>
            </form>
        </div>
    </div>

    <div id="deleteModal1" class="hidden fixed top-0 left-0 flex items-center justify-center w-full h-full">
        <div class="absolute z-99 bg-white p-6 rounded-lg space-y-5">
            ...
            <div class="flex justify-end gap-3">
                <button class="text-white bg-[#FF000D] py-2 rounded-lg px-10">Oke</button>
                <button onclick="toggleDeleteModal(1)" class="bg-[#D7D7D7] py-2 rounded-lg px-10">Tutup</button>
            </div>
        </div>
    </div>
@endsection
