                                ...
                                <div id="editModal{{ $d->id }}"
                                    ...
                                    <div class="absolute z-99 bg-white p-6 rounded-lg space-y-5 w-2/5">
                                        <div class="flex justify-between items-center border-b border-black pb-4">
                                            ...
                                            <button onclick="toggleEditModal({{ $d->id }})">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                    stroke-width="1.5" stroke="currentColor" class="w-6 h-6 stroke-red-700">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                        d="M6 18L18 6M6 6l12 12" />
                                                </svg>
                                            </button>
                                        </div>
                                        <form action="{{ route('video-setting.update', $d->id) }}" method="POST"
                                            ...
                                            <div class="space-y-2 col-span-2">
                                                ...
                                                <input type="file" required name="video" accept="video/*"
                                                    id="file2" class="hidden">
                                            </div>
                                            <button type="submit"
                                                class="bg-blue-600 w-full rounded-lg py-2 text-white">Simpan</button>
                                        </form>
                                    </div>
                                </div>
