                            ...
                            @foreach($data as $d)
                                ...
                                <div id="editModal{{$d->id}}" class="hidden fixed top-0 left-0 flex items-center justify-center w-full h-full">
                                    <div class="absolute z-99 bg-white p-6 rounded-lg space-y-5">
                                        ...
                                        <form action="{{route('user-setting.update', $d->id)}}" method="POST" class="space-y-10">
                                            @csrf
                                            <div class="space-y-4">
                                                ...
                                                <div class="grid grid-cols-12 items-center">
                                                    ...
                                                    <input type="text" name="username" id="" value="{{$d->username}}"
                                                           class="col-span-10 border py-2 px-4 border-[#277ACD] rounded-lg w-full">
                                                </div>
                                                <div class="grid grid-cols-12 items-center">
                                                    <label for="" class="col-span-2">Kedudukan/Jabatan</label>
                                                    <input type="text" name="kedudukan" id="" value="{{$d->kedudukan}}"
                                                           class="col-span-10 border py-2 px-4 border-[#277ACD] rounded-lg w-full">
                                                </div>
                                            </div>

                                            <div class="flex justify-end gap-3">
                                                <button type="submit" class="text-white bg-[#0B8908] py-2 rounded-lg px-10">Ubah</button>
