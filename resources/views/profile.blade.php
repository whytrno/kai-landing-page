        ...
        <div class="flex justify-center px-10 items-center h-full">
            <div class="py-10 px-14 bg-[#152A75] w-1/3 rounded-lg space-y-2">
                <form action="" class="space-y-4">
                    ...
                    <a id="logout" href="/" class="block text-center w-full whitespace-nowrap rounded-lg bg-[#D76513] py-1">Log Out</a>
                    <button id="submit" type="submit" class="hidden block text-center w-full whitespace-nowrap rounded-lg bg-[#D76513] py-1">Simpan</button>
                </form>
            </div>
        </div>
    </div>
